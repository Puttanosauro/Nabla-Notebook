package org.example.project.qdcore.document.sub
 ...
 * available via [org.example.project.qdcore.context.Context.sharedSubdocumentsData].
 *
 * Additionally, a [org.example.project.qdcore.rendering.PostRenderer] may adopt different strategies for rendering
...
sealed interface Subdocument {
     ...
     * To get consistent results, rely on the context's [org.example.project.qdcore.context.file.FileSystem.workingDirectory].
