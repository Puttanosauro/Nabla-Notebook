...
import org.example.project.qdcore.function.expression.SafeExpression
import org.example.project.qdcore.function.expression.eval
import org.example.project.qdcore.function.quarkdownName
import org.example.project.qdcore.function.reflect.FromDynamicType
...
import org.example.project.qdcore.function.value.data.EvaluableString
import org.example.project.qdcore.function.value.data.Lambda
import org.example.project.qdcore.function.value.data.Range
import org.example.project.qdcore.function.value.factory.ValueFactory.eval
import org.example.project.qdcore.function.value.factory.ValueFactory.expression
import org.example.project.qdcore.function.value.factory.ValueFactory.iterable
import org.example.project.qdcore.function.value.factory.ValueFactory.lambda
import org.example.project.qdcore.function.value.factory.ValueFactory.range
import org.example.project.qdcore.function.value.factory.ValueFactory.safeExpression
import org.example.project.qdcore.function.value.factory.ValueFactory.size
...
import org.example.project.qdcore.parser.walker.lambda.LambdaParser
import org.example.project.qdcore.pipeline.error.PipelineException
import org.example.project.qdcore.pipeline.error.UnattachedPipelineException
...
import org.example.project.qdcore.util.node.conversion.list.MarkdownListToCollectionValue
import org.example.project.qdcore.util.node.conversion.list.MarkdownListToDictionaryValue
 ...
 * @see org.example.project.qdcore.function.reflect.FromDynamicType
 * @see org.example.project.qdcore.function.reflect.DynamicValueConverter.convertTo
 */
object ValueFactory {
    /**
     ...
     * This is generally an *unsafe* expression, as evaluating it may throw an [org.example.project.qdcore.function.error.internal.InvalidExpressionEvalException].
    ...
    /**
     * Evaluates a dynamic expression from a raw string input.
     * This is a safe expression, meaning that if an [org.example.project.qdcore.function.error.internal.InvalidExpressionEvalException] is caught while
