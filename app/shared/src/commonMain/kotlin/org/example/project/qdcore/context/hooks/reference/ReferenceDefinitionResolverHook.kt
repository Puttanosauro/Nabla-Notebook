...
import org.example.project.qdcore.ast.attributes.reference.setDefinition
 ...
 * @param R the type of the reference element (for example [org.example.project.qdcore.ast.base.inline.ReferenceFootnote])
 * @param DN the type of the node that carries the definition (for example [org.example.project.qdcore.ast.base.block.FootnoteDefinition])
