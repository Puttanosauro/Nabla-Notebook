...
import org.example.project.qdcore.lexer.patterns.TextSymbolReplacement
 ...
 * Examples: `&`, `<`, `>`, `"`, `'`, ...
 * @see org.example.project.qdcore.ast.base.inline.CriticalContent
 */
 ...
 * ````code````
 * ```
 * @see org.example.project.qdcore.ast.base.inline.CodeSpan
 */
class CodeSpanToken(
    data: TokenData,
) : Token(data) {
 ...
 * Line 2
 * ```
 * @see org.example.project.qdcore.ast.base.inline.LineBreak
 */
 ...
 * [label]
 * ```
 * @see org.example.project.qdcore.ast.base.inline.ReferenceLink
 */
 ...
 * [^: definition]
 * ```
 * @see org.example.project.qdcore.ast.base.inline.ReferenceFootnote
 */
 ...
 * ![Label](img.png)
 * ```
 * @see org.example.project.qdcore.ast.base.inline.Image
 */
class ImageToken(
    data: TokenData,
) : Token(data) {
 ...
 * ![label]
 * ```
 * @see org.example.project.qdcore.ast.base.inline.ReferenceImage
 */
 ...
 * <!-- comment -->
 * ```
 * @see org.example.project.qdcore.ast.base.inline.Comment
 */
class CommentToken(
    data: TokenData,
) : Token(data) {
...
/**
 * Text content.
 * @see org.example.project.qdcore.ast.base.inline.Text
 */
 ...
 * @see org.example.project.qdcore.ast.quarkdown.inline.TextSymbol
 */
 ...
 * __strong__
 * ```
 * @see org.example.project.qdcore.ast.base.inline.Strong
 */
class StrongToken(
    data: TokenData,
) : Token(data) {
 ...
 * _emphasis_
 * ```
 * @see org.example.project.qdcore.ast.base.inline.Emphasis
 */
class EmphasisToken(
    data: TokenData,
) : Token(data) {
 ...
 * ___emphasis___
 * ```
 * @see org.example.project.qdcore.ast.base.inline.StrongEmphasis
 */
 ...
 * ~~text~~
 * ```
 * @see org.example.project.qdcore.ast.base.inline.Strikethrough
 */
 ...
 * Example:
 * $ LaTeX expression $
 * @see org.example.project.qdcore.ast.quarkdown.inline.MathSpan
 */
