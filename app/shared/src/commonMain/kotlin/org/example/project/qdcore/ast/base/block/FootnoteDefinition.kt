...
import org.example.project.qdcore.ast.attributes.id.Identifiable
import org.example.project.qdcore.ast.attributes.id.IdentifierProvider
...
import org.example.project.qdcore.document.numbering.DecimalNumberingSymbol
...
/**
 * Creation of a footnote definition, referenceable by a [org.example.project.qdcore.ast.base.inline.ReferenceFootnote].
 * @param label inline content of the referenceable label, which should match that of the [org.example.project.qdcore.ast.base.inline.ReferenceFootnote]s
