...
import org.example.project.qdcore.function.error.internal.InvalidExpressionEvalException
...
class AppendExpressionVisitor(
     ...
     * @throws InvalidExpressionEvalException if either [this] or [other] is a [NodeValue] (see [org.example.project.qdcore.function.value.factory.ValueFactory.eval])
     */
