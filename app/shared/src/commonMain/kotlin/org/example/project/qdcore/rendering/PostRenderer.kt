...
interface PostRenderer {
     ...
     * which complies with [org.example.project.qdcore.pipeline.Pipeline.execute]'s output type.
     *
     * Wrapping can happen by:
     * - Grouping the resources into an [org.example.project.qdcore.pipeline.output.OutputResourceGroup] (e.g. HTML output).
