package org.example.project.qdcore.media.passthrough
 ...
 * - Excluded from [org.example.project.qdcore.context.hooks.LinkUrlResolverHook] resolution, preserving the `@` prefix intact.
 * - Excluded from [org.example.project.qdcore.context.hooks.MediaStorerHook] registration, since the referenced file
 ...
 * is performed by the active [org.example.project.qdcore.rendering.NodeRenderer].
 *
 * @see org.example.project.qdcore.rendering.NodeRenderer
 */
