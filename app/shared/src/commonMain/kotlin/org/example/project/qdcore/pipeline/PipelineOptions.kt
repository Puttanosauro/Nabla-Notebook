...
import org.example.project.qdcore.document.sub.SubdocumentOutputNaming
import org.example.project.qdcore.media.storage.options.MediaStorageOptions
import org.example.project.qdcore.media.storage.options.ReadOnlyMediaStorageOptions
 ...
 * Note: subdocuments may have different working directories. For consistent results rely on [org.example.project.qdcore.context.file.FileSystem.workingDirectory]
 ...
 * as the media architecture is defined by Quarkdown through a [org.example.project.qdcore.context.hooks.MediaStorerHook].
