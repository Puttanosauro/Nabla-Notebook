...
import org.example.project.qdcore.ast.attributes.location.SectionLocation
 ...
 * which is not known until the AST is fully traversed by [org.example.project.qdcore.context.hooks.location.LocationAwareLabelStorerHook].
 *
 * After the traversal, the [org.example.project.qdcore.context.hooks.location.NumberedEvaluatorHook] will evaluate and assign the [children] of this node, ready to be rendered.
 *
 * Since the evaluation does not happen within [org.example.project.qdcore.function.call.FunctionCallNodeExpander],
 ...
 * @see org.example.project.qdcore.context.hooks.location.LocationAwareLabelStorerHook for storing locations
 * @see org.example.project.qdcore.context.hooks.location.NumberedEvaluatorHook for evaluating [location] and [childrenSupplier]
 * @see org.example.project.qdcore.document.numbering.NumberingFormat
 */
class Numbered(
    val key: String,
